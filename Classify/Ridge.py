...
from Classify.LossFunction import RidgeLoss
...
criterion = RidgeLoss().to(device)

train_loader, test_loader, input_dim = load_data()

models = [RidgeRegression(input_dim + 1, lr, device) for i in range(0, 10)]
